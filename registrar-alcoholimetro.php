...
$breadcrumbs = [
    'index.php' => 'Dashboard',
    'registrar-alcoholimetro.php' => 'Alcoholímetros'
];
...
if (isset($_GET['eliminar'])) {
    ...
    try {
        // Verificar si el alcoholímetro tiene pruebas asociadas
...
<div class="content-body">
    ...
    <div class="dashboard-header">
        ...
        <div class="header-actions">
            <?php if ($modo_edicion): ?>
                <a href="registrar-alcoholimetro.php" class="btn btn-outline">
...
<!-- ESTILOS ESPECÍFICOS CORREGIDOS PARA ALCOHOLÍMETROS -->
<style>
...
.account-form select.form-control:hover {
...
.account-form select.form-control:focus {
...
.account-form .form-control:focus ~ .form-text {
    color: var(--primary);
}
...
<script>
// Funciones JavaScript para mejorar UX
